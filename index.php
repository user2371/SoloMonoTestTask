		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-4">
					<h3>Завдання 2</h3>
					<ul>
						<li>При наведенні на категорію "Комп`ютери", показувати список підкатегорій (без JS, використати
							масив PHP <b>$sub_categories</b>)</li>
						<li>Не наводячи на пункт "Комп`ютери" потрібно, щоб візуально було видно і зрозуміло, що в ньому є
							список підкатегорій</li>
